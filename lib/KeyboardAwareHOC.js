...
export type KeyboardAwareHOCOptions = ?{
  ...
  contentContainerStyleWithoutKeyboard: ?Object,
  enableAutomaticScroll: boolean,
  extraHeight: number,
  extraScrollHeight: number,
  enableResetScrollToCoords: boolean,
...
const ScrollIntoViewDefaultOptions: KeyboardAwareHOCOptions = {
  ...
  contentContainerStyleWithoutKeyboard: {},
...
function KeyboardAwareHOC(
  ...
  return class
    ...
    static propTypes = {
      ...
      contentContainerStyleWithoutKeyboard: PropTypes.any,
    ...
    render() {
      let { enableOnAndroid, contentContainerStyle, onScroll, contentContainerStyleWithoutKeyboard } = this.props

      if(contentContainerStyleWithoutKeyboard && this.state.keyboardSpace === 0) {
